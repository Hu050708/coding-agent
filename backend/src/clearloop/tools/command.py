...
from clearloop.security.command_policy import CommandDecision, CommandRequest
from clearloop.security.workspace import Workspace
...
def run_command(
    ...
    *,
    ...
    stdout_thread = threading.Thread(
        ...
        name="clearloop-stdout-drain",
        daemon=True,
    )
    stderr_thread = threading.Thread(
        target=_drain_pipe,
        args=(process.stderr, stderr_capture),
        name="clearloop-stderr-drain",
        daemon=True,
    )
    stdout_thread.start()
    stderr_thread.start()
