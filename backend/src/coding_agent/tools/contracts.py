...
from coding_agent.security.command_policy import CommandRequest


class ToolError(Exception):
    """Structured failure returned across the tool-registry boundary."""
...
CommandConfirmation = Callable[[CommandRequest], bool]
